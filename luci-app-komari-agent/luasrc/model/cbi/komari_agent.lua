...
local include_nics = s:option(DynamicList, "include_nics", translate("Include NICs"),
...
local exclude_nics = s:option(DynamicList, "exclude_nics", translate("Exclude NICs"),
